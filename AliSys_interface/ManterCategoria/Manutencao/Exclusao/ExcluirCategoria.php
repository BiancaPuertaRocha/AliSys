<html>
    ...
    <body onload="javascript:exibeDataHora('hora');" style='background-attachment:fixed;' background="../../../imagens/madeira.jpg" bgproperties="fixed">
        <div  class="container">
            ...
            <?php
            include'../../../cabeca.php';
            echo '<center><h3>Deseja Mesmo Excluir Esta categoria? </h3> </center><br>';

            include '../../../ConectaBanco.php';

            $busca = "select * from categoria where codigo=" . $_GET['codigo'] . ";";
            ...
            echo '<br> <br> <div class="col-md-offset-1 col-sm-4">
              <a  href="ExcluirCategoriaMesmo.php?codigo=' . $produto['codigo'] . '" class="btn btn-success">Excluir</a>
              <a  href="../../Pesquisa/ManterCategoria.php" class="btn btn-danger">Cancelar</a>
