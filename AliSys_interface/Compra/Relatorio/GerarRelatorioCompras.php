...
<html>
    ...
    <body onload="javascript:exibeDataHora('hora');" style='background-attachment:fixed;' background="../../imagens/madeira.jpg" bgproperties="fixed">
        ...
        ?>
        <div class="container">
            <h1 class="text-center">Gerar Relatório de Compras</h1></br></br>
            <form class="form-horizontal" method="POST" action="GerarRelatorioCompras.php"><!--qual ação vai ser executada quando enviar -->
            ...
            <table class="table table-condensed table-striped" style="background-color:#DCDCDC">
                ...
                if (isset($_POST['data1']) && isset($_POST['data2'])) {
                    ...
                    $busca = "select compra.*, fornecedor.nomefant as nomefa from compra inner join fornecedor on fornecedor.codigo= compra.fornecedor_codigo"
                    ...
                    echo "<tr><th >Codigo</th ><th >Fornecedor </th>"
                    . "<th  > Valor </th><th  >Data</th> <th >Opções</th></tr>";
                    while ($venda) {
                        echo "<tr><td>" . $venda['codigo'] . "</td><td>" . $venda['nomefa'] . "</td><td>R$ " . $venda['valortotal'] . "</td>"
                        . "<td>" . $venda['datapag'] . "</td><td><a class='btn btn-default' href='DetalhesCompra.php?codigo=" . $venda['codigo'] . "'>Detalhes</td></tr>";
                        $venda = mysqli_fetch_assoc($resultado);
                    }
                    mysqli_close($conexao);
                    echo"<a href='RelatorioCompras.php?data1=$busca1&data2=$busca2' class='btn btn-primary'>Gerar Relatório "
